...
const Footer: React.FC = () => {
  ...
  const socialLinks = [
    { name: "GitHub", href: "https://github.com/nit-silchar", icon: "github" },
    ...
    <footer className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-gray-200 py-12 mt-16">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start gap-2 text-sm text-gray-400">
                <span className="mt-0.5 flex-shrink-0">{icons.phone}</span>
                <span>+91 XXXX-XXXXXX</span>
              </li>
              <li className="flex items-start gap-2 text-sm text-gray-400">
                <span className="mt-0.5 flex-shrink-0">{icons.location}</span>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-gray-400">
          <p>
            © {currentYear} National Institute of Technology Silchar. All Rights Reserved.
          </p>
        ...
        <p className="text-xs text-gray-500 text-center mt-4">
          Designed & Developed as part of Software Engineering (CS 304) Assignment
        </p>
      </div>
    </footer>
  );
